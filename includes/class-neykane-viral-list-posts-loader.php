 ...
 */
class Neykane_Viral_List_Posts_Loader {
	 ...
	 * @param int $priority The priority at which the shortcode function should be fired.
	 * @param int $accepted_args The number of arguments that should be passed to the shortcode $callback.
	 *
	 * @since     1.0.0
	 */
